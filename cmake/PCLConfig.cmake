...
macro(find_boost)
  ...
  elseif(NOT BOOST_INCLUDEDIR)
    set(BOOST_INCLUDEDIR "D:/Boost/include/boost-1_59")
...
macro(find_eigen)
  ...
  elseif(NOT EIGEN_ROOT)
    get_filename_component(EIGEN_ROOT "D:/eigen/include/eigen3" ABSOLUTE)
  endif(PCL_ALL_IN_ONE_INSTALLER)
  if(PKG_CONFIG_FOUND)
...
macro(find_qhull)
  ...
  elseif(NOT QHULL_ROOT)
    get_filename_component(QHULL_ROOT "D:/Program Files/PCL 1.7.2/3rdParty/Qhull/include" PATH)
  endif(PCL_ALL_IN_ONE_INSTALLER)
...
macro(find_openni2)
  ...
  if(NOT OPENNI2_ROOT AND ("TRUE" STREQUAL "TRUE"))
    set(OPENNI2_INCLUDE_DIRS_HINT "C:/Program Files/OpenNI2/Include")
    get_filename_component(OPENNI2_LIBRARY_HINT "C:/Program Files/OpenNI2/Lib/OpenNI2.lib" PATH)
  endif()
...
macro(find_flann)
  ...
  elseif(NOT FLANN_ROOT)
    get_filename_component(FLANN_ROOT "D:/flann/include" PATH)
  endif(PCL_ALL_IN_ONE_INSTALLER)
  if(PKG_CONFIG_FOUND)
...
elseif(EXISTS "${PCL_DIR}/include/pcl/pcl_config.h")
  ...
  set(PCL_SOURCES_TREE "D:/pcl-master")
...
set(pcl_all_components  common octree io kdtree search sample_consensus filters 2d geometry features ml segmentation visualization surface registration keypoints tracking recognition stereo apps cuda_common cuda_features cuda_segmentation cuda_sample_consensus outofcore gpu_containers gpu_utils gpu_octree gpu_features gpu_segmentation people )
